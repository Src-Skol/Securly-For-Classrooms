(function () {
...
})()(
  {
    ...
    2: [
      ...
      { "./stun.json": 3, "./turn.json": 4, normalice: 11 },
    ],
    3: [
      function (require, module, exports) {
        module.exports = [
    ...
    7: [
      function (require, module, exports) {
        ...
        function JL(loggerName) {
          ...
          var logger = ("." + loggerName).split(".").reduce(function (
            prev,
            curr,
            idx,
            arr,
        ...
        (function (JL) {
          ...
          function allow(filters) {
            ...
            try {
              if (filters.userAgentRegex) {
                if (
                  !new RegExp(filters.userAgentRegex).test(navigator.userAgent)
                ) {
                  return false;
                }
              }
          ...
          function stringifyLogObject(logObject) {
            ...
            switch (typeof actualLogObject) {
              case "string":
                return new StringifiedLogObject(
                  actualLogObject,
                  null,
                  actualLogObject,
                );
              ...
              case "object":
                if (
                  actualLogObject instanceof RegExp ||
          ...
          var AjaxAppender = (function (_super) {
            ...
            function AjaxAppender(appenderName) {
              return (
                _super.call(
                  this,
                  appenderName,
                  AjaxAppender.prototype.sendLogItemsAjax,
                ) || this
              );
            }
            ...
            AjaxAppender.prototype.sendLogItemsAjax = function (
              logItems,
              successCallback,
            ) {
              try {
                ...
                var json = { r: JL.requestId, lg: logItems };
          ...
          var ConsoleAppender = (function (_super) {
            ...
            function ConsoleAppender(appenderName) {
              return (
                _super.call(
                  this,
                  appenderName,
                  ConsoleAppender.prototype.sendLogItemsConsole,
                ) || this
              );
            }
            ...
            ConsoleAppender.prototype.sendLogItemsConsole = function (
              logItems,
              successCallback,
            ) {
              try {
              ...
              if (level >= this.level && allow(this)) {
                ...
                if (allowMessage(this, compositeMessage.finalString)) {
                  if (this.onceOnly) {
                    ...
                    while (i >= 0) {
                      if (
                        new RegExp(this.onceOnly[i]).test(
                          compositeMessage.finalString,
                        )
                      ) {
            ...
            (function () {
              ...
              function parse(ua) {
                ...
                if (
                  ...
                  !product &&
                  (data =
                    /\bAndroid[^;]*;(.*?)(?:Build|\) AppleWebKit)\b/i.exec(ua))
                ) {
                  product =
                    trim(data[1]).replace(/^[a-z]{2}-[a-z]{2};\s*/i, "") ||
                    null;
                }
                ...
                if (
                  name == "Fennec" ||
                  (name == "Firefox" &&
                    /\b(?:Android|Firefox OS|KaiOS)\b/.test(os))
                ) {
                  name = "Firefox Mobile";
                ...
                if ((data = (/\bAppleWebKit\/([\d.]+\+?)/i.exec(ua) || 0)[1])) {
                  ...
                  data[1] = (/\b(?:Headless)?Chrome\/([\d.]+)/i.exec(ua) ||
                    0)[1];
                  if (
                    data[0] == 537.36 &&
                    data[2] == 537.36 &&
    ...
    14: [
      function (require, module, exports) {
        ...
        const { re: re, t: t } = require("../internal/re");
      ...
      },
      {
        ...
        "../internal/debug": 18,
        "../internal/identifiers": 19,
        "../internal/parse-options": 20,
        "../internal/re": 21,
      },
    ],
    15: [
      ...
      function (require, module, exports) {
        ...
        function v1(options, buf, offset) {
          ...
          if (node == null || clockseq == null) {
            ...
            if (clockseq == null) {
              clockseq = _clockseq =
                ((seedBytes[6] << 8) | seedBytes[7]) & 16383;
            }
          }
      ...
      function (require, module, exports) {
        module.exports = {
          ...
          scripts: {
            ...
            build:
              "cd src/OpenVidu && ./../../node_modules/typescript/bin/tsc && cd ../.. && ./node_modules/typescript/bin/tsc --declaration src/index.ts --outDir ./lib --sourceMap --target es5 --lib dom,es5,es2015.promise,scripthost && rm -rf ./ts4.4 && mkdir -p ./ts4.4/lib && cp -r ./lib ./ts4.4 && find ./ts4.4/lib -type f ! -iname '*.d.ts' -delete && ./config/replace_for_ts44.sh",
    ...
    41: [
        ...
        var Connection = (function () {
          function Connection(session, connectionOptions) {
            ...
            if (!!connectionOptions.role) {
              ...
              msg +=
                "(remote) with 'connectionId' [" + this.remoteOptions.id + "]";
            }
            logger.info(msg);
          }
              ...
              function (error, response) {
                if (error) {
                  ...
                  _this.session.emitEvent("exception", [
                    new ExceptionEvent_1.ExceptionEvent(
                      _this.session,
                      ExceptionEvent_1.ExceptionEventName.ICE_CANDIDATE_ERROR,
                      _this.session,
      ...
      {
        "../OpenViduInternal/Events/ExceptionEvent": 58,
        "../OpenViduInternal/Logger/OpenViduLogger": 79,
        "./Stream": 48,
      },
    ],
    42: [
      function (require, module, exports) {
        ...
        var EventDispatcher = (function () {
          ...
          EventDispatcher.prototype.onceAux = function (
            type,
            message,
            handler,
          ) {
    ...
    43: [
          ...
          Filter.prototype.execMethod = function (method, params) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              if (_this.type.startsWith("VB:")) {
                  ...
                  try {
                    ...
                    return reject(
                      new OpenViduError_1.OpenViduError(
                        OpenViduError_1.OpenViduErrorName.VIRTUAL_BACKGROUND_ERROR,
                ...
                if (method === "update") {
                  if (
                    !((_a = _this.stream.virtualBackgroundSinkElements) ===
                      null || _a === void 0
                      ? void 0
                      : _a.VB)
                  ) {
                    ...
                    _this.stream.virtualBackgroundSinkElements.VB.updateValues(
                      params,
                    )
                      .then(function () {
                      ...
                      .catch(function (error) {
                        if (
                          ...
                          return reject(
                            new OpenViduError_1.OpenViduError(
                              OpenViduError_1.OpenViduErrorName.VIRTUAL_BACKGROUND_ERROR,
                              "Error updating values on Virtual Background filter: " +
                                error,
                            ),
                          );
                        }
                  ...
                  return reject(
                    new OpenViduError_1.OpenViduError(
                      OpenViduError_1.OpenViduErrorName.VIRTUAL_BACKGROUND_ERROR,
                      'Unknown Virtual Background method "'.concat(method, '"'),
                    ),
                  );
                }
              } else {
      ...
      {
        "../OpenViduInternal/Enums/OpenViduError": 52,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 67,
        "../OpenViduInternal/Logger/OpenViduLogger": 79,
      },
    ],
    44: [
      function (require, module, exports) {
        ...
        var LocalRecorder = (function () {
            ...
            return new Promise(function (resolve, reject) {
              try {
                if (typeof options === "string" || options instanceof String) {
                  return reject(
                    "When calling LocalRecorder.record(options) parameter 'options' cannot be a string. Must be an object like { mimeType: \"".concat(
                      options,
                      '" }',
                    ),
                  );
          ...
          LocalRecorder.prototype.uploadAsBinary = function (
            endpoint,
            headers,
          ) {
            var _this = this;
            ...
            return new Promise(function (resolve, reject) {
              if (
                ...
                sendable.append(
                  "file",
                  _this.blob,
                  _this.id + "." + Mime.getExtension(_this.blob.type),
                );
      ...
      {
        "../OpenViduInternal/Enums/LocalRecorderState": 51,
        "../OpenViduInternal/Logger/OpenViduLogger": 79,
        "../OpenViduInternal/Utils/Platform": 83,
        "mime/lite": 9,
      },
    ],
    45: [
      function (require, module, exports) {
        ...
        var OpenVidu = (function () {
          function OpenVidu() {
            ...
            this.sendBrowserLogs =
              OpenViduLoggerConfiguration_1.OpenViduLoggerConfiguration.disabled;
              ...
              this.onOrientationChanged(function () {
                _this.publishers.forEach(function (publisher) {
                  if (
                    ...
                    _this.sendNewVideoDimensionsIfRequired(
                      publisher,
                      "deviceRotated",
                      75,
                      10,
                  ...
                  if (
                    ...
                    ((_a =
                      cordova === null || cordova === void 0
                        ? void 0
                        : cordova.plugins) === null || _a === void 0
                      ? void 0
                      : _a.EnumerateDevicesPlugin)
                  ) {
            ...
            return new Promise(function (resolve, reject) {
              return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_c) {
                  switch (_c.label) {
                    case 0:
                      askForAudioStreamOnly = function (
                        previousMediaStream,
                        constraints,
                      ) {
                        return __awaiter(_this, void 0, void 0, function () {
                          ...
                          return __generator(this, function (_a) {
                            switch (_a.label) {
                              ...
                              case 2:
                                ...
                                previousMediaStream.addTrack(
                                  audioOnlyStream.getAudioTracks()[0],
                                );
                    ...
                    case 2:
                      ...
                      if (
                        !(
                          ...
                          (!!myConstraints.audioTrack &&
                            ((_a = myConstraints.constraints) === null ||
                            _a === void 0
                              ? void 0
                              : _a.video) === false) ||
                          (!!myConstraints.videoTrack &&
                            ((_b = myConstraints.constraints) === null ||
                            _b === void 0
                              ? void 0
                              : _b.audio) === false)
                        )
          ...
          OpenVidu.prototype.sendNewVideoDimensionsIfRequired = function (
            publisher,
            reason,
            WAIT_INTERVAL,
            MAX_ATTEMPTS,
            ...
            var oldWidth =
              ((_b =
                (_a =
                  publisher === null || publisher === void 0
                    ? void 0
                    : publisher.stream) === null || _a === void 0
                  ? void 0
                  : _a.videoDimensions) === null || _b === void 0
                ? void 0
                : _b.width) || 0;
            var oldHeight =
              ((_d =
                (_c =
                  publisher === null || publisher === void 0
                    ? void 0
                    : publisher.stream) === null || _c === void 0
                  ? void 0
                  : _c.videoDimensions) === null || _d === void 0
                ? void 0
                : _d.height) || 0;
            var repeatUntilChangeOrMaxAttempts = setInterval(function () {
              ...
              publisher.getVideoDimensions().then(function (newDimensions) {
                if (
                  newDimensions.width !== oldWidth ||
                  newDimensions.height !== oldHeight
                ) {
                  clearTimeout(repeatUntilChangeOrMaxAttempts);
                  _this.sendVideoDimensionsChangedEvent(
                    publisher,
                    reason,
                    oldWidth,
                    oldHeight,
          ...
          OpenVidu.prototype.sendVideoDimensionsChangedEvent = function (
            publisher,
            reason,
            oldWidth,
            oldHeight,
          ...
          OpenVidu.prototype.sendTrackChangedEvent = function (
            publisher,
            reason,
            oldLabel,
            newLabel,
          ...
          OpenVidu.prototype.generateMediaConstraints = function (
            ...
            return new Promise(function (resolve, reject) {
              var myConstraints = {
                ...
                constraints: { audio: undefined, video: undefined },
              };
              ...
              _this.configureDeviceIdOrScreensharing(
                myConstraints,
                publisherProperties,
                resolve,
                reject,
            ...
            var config = {
              ...
              rpc: {
                ...
                participantUnpublished:
                  this.session.onParticipantUnpublished.bind(this.session),
                ...
                streamPropertyChanged:
                  this.session.onStreamPropertyChanged.bind(this.session),
                connectionPropertyChanged:
                  this.session.onConnectionPropertyChanged.bind(this.session),
                networkQualityLevelChanged:
                  this.session.onNetworkQualityLevelChangedChanged.bind(
                    this.session,
                  ),
                filterEventDispatched:
                  this.session.onFilterEventDispatched.bind(this.session),
                iceCandidate: this.session.recvIceCandidate.bind(this.session),
                mediaError: this.session.onMediaError.bind(this.session),
                masterNodeCrashedNotification:
                  this.onMasterNodeCrashedNotification.bind(this),
                forciblyReconnectSubscriber:
                  this.session.onForciblyReconnectSubscriber.bind(this.session),
              },
            };
            this.jsonRpcClient = new RpcBuilder.clients.JsonRpcClient(config);
          };
          OpenVidu.prototype.onMasterNodeCrashedNotification = function (
            response,
          ) {
          ...
          OpenVidu.prototype.sendRequest = function (method, params, callback) {
            ...
            (_a = this.jsonRpcClient) === null || _a === void 0
              ? void 0
              : _a.send(method, params, callback);
          };
          ...
          OpenVidu.prototype.generateAudioDeviceError = function (
            error,
            constraints,
          ) {
            if (error.name === "Error") {
            ...
            if (!!myConstraints.videoTrack) {
              ...
              if (!!stream) {
                if (!!myConstraints.constraints.video) {
                  stream.lastVideoTrackConstraints =
                    myConstraints.constraints.video;
                } else {
                  stream.lastVideoTrackConstraints =
                    myConstraints.videoTrack.getConstraints();
                }
              }
            }
            if (!!myConstraints.audioTrack) {
          ...
          OpenVidu.prototype.configureDeviceIdOrScreensharing = function (
            myConstraints,
            publisherProperties,
            resolve,
            reject,
                ...
                if (!this.checkScreenSharingCapabilities()) {
                  ...
                  if (platform.isElectron()) {
                    ...
                    if (
                      ...
                      screenSharing.getScreenConstraints(
                        function (error, screenConstraints) {
                          if (
                            !!error ||
          ...
          OpenVidu.prototype.setVideoSource = function (
            myConstraints,
            videoSource,
          ) {
            if (!myConstraints.constraints.video) {
          ...
          OpenVidu.prototype.reconnectWebsocketThroughRpcConnectMethod =
            function (rpcSessionId) {
              var _this = this;
              this.sendRequest(
                "connect",
                { sessionId: rpcSessionId, reconnect: true },
                function (error, response) {
                  if (!!error) {
                    if (_this.isMasterNodeCrashed()) {
                      ...
                      var notifyLostConnection_1 = function (reason, errorMsg) {
                        ...
                        _this.jsonRpcClient.close(
                          4101,
                          "Reconnection fault: " + errorMsg,
                        );
                      };
                      var rpcSessionStatus = function () {
                        if (_this.life === -1) {
                          notifyLostConnection_1(
                            "networkDisconnect",
                      ...
                      if (
                        error.code === 40007 &&
                        error.message === "reconnection error"
                      ) {
                        console.error(
          ...
          OpenVidu.prototype.reconnectedCallback = function () {
            ...
            if (this.isRoomAvailable()) {
              if (!!this.session.connection) {
                this.reconnectWebsocketThroughRpcConnectMethod(
                  this.session.connection.rpcSessionId,
                );
              } else {
                logger.warn(
                  "There was no previous connection when running reconnection callback",
                );
                var sessionDisconnectEvent =
                  new SessionDisconnectedEvent_1.SessionDisconnectedEvent(
                    this.session,
                    "networkDisconnect",
                  );
                this.session.ee.emitEvent("sessionDisconnected", [
      ...
      },
      {
        "../../package.json": 39,
        "../OpenViduInternal/Enums/OpenViduError": 52,
        "../OpenViduInternal/Enums/VideoInsertMode": 54,
        "../OpenViduInternal/Events/SessionDisconnectedEvent": 63,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 67,
        "../OpenViduInternal/KurentoUtils/kurento-jsonrpc": 74,
        "../OpenViduInternal/Logger/OpenViduLogger": 79,
        "../OpenViduInternal/Logger/OpenViduLoggerConfiguration": 80,
        "../OpenViduInternal/ScreenSharing/Screen-Capturing": 82,
        "../OpenViduInternal/ScreenSharing/Screen-Capturing-Auto": 81,
        "../OpenViduInternal/Utils/Platform": 83,
        "./LocalRecorder": 44,
        "./Publisher": 46,
        "./Session": 47,
    ...
    46: [
      function (require, module, exports) {
        ...
        var Publisher = (function (_super) {
          ...
          Publisher.prototype.publishVideo = function (enabled, resource) {
            ...
            return new Promise(function (resolve, reject) {
              return __awaiter(_this, void 0, void 0, function () {
                var affectedMediaStream_1,
                  mustRestartMediaStream_1,
                  oldVideoTrack,
                  replaceVideoTrack,
                  mediaStream,
                  error_1;
                                        ...
                                        return __generator(this, function (_a) {
                                          switch (_a.label) {
                                            case 0:
                                              ...
                                              if (
                                                !!lastExecMethod &&
                                                lastExecMethod.method ===
                                                  "update"
                                              ) {
                                                options = Object.assign(
                                                  {},
                                                  options,
                                                  lastExecMethod.params,
                                                );
                                              }
                                              return [
                                                4,
                                                this.stream.applyFilter(
                  ...
                  switch (_c.label) {
                    case 0:
                      ...
                      errorCallback = function (openViduError) {
                        ...
                        logger.error(
                          "Publisher initialization failed. "
                            .concat(openViduError.name, ": ")
                            .concat(openViduError.message),
                        );
                      ...
                      successCallback = function (mediaStream) {
                        ...
                        if (
                          typeof MediaStreamTrack !== "undefined" &&
                          _this.properties.audioSource instanceof
                            MediaStreamTrack
                        ) {
                        ...
                        if (
                          typeof MediaStreamTrack !== "undefined" &&
                          _this.properties.videoSource instanceof
                            MediaStreamTrack
                        ) {
                          mediaStream.removeTrack(
                        ...
                        if (!!mediaStream.getAudioTracks()[0]) {
                          var enabled =
                            ...
                            _this.stream.audioActive !== null
                              ...
                              : !!_this.stream.outboundStreamOpts
                        ...
                        for (
                          var _i = 0, _c = mediaStream.getAudioTracks();
                          _i < _c.length;
                          _i++
                        ) {
                          var track = _c[_i];
                          if (
                            !((_a = track.contentHint) === null || _a === void 0
                              ? void 0
                              : _a.length)
                          ) {
                            track.contentHint = "";
                            logger.info(
                              "Audio track Content Hint set: '".concat(
                                track.contentHint,
                                "'",
                              ),
                            );
                        ...
                        for (
                          var _d = 0, _e = mediaStream.getVideoTracks();
                          _d < _e.length;
                          _d++
                        ) {
                          var track = _e[_d];
                          if (
                            !((_b = track.contentHint) === null || _b === void 0
                              ? void 0
                              : _b.length)
                          ) {
                            ...
                            logger.info(
                              "Video track Content Hint set: '".concat(
                                track.contentHint,
                                "'",
                              ),
                            );
                        ...
                        if (_this.stream.isSendVideo()) {
                          _this
                            ...
                            .then(function (dimensions) {
                                ...
                                _this.screenShareResizeInterval = setInterval(
                                  function () {
                                    ...
                                    if (
                                      ...
                                      _this.openvidu.sendVideoDimensionsChangedEvent(
                                        _this,
                                        "screenResized",
                                        _this.stream.videoDimensions.width,
                                        _this.stream.videoDimensions.height,
                              ...
                              _this.stream.ee.emitEvent(
                                "stream-ready-to-publish",
                                [],
                              );
                            });
                        } else {
                          ...
                          return __generator(this, function (_a) {
                            switch (_a.label) {
                              ...
                              case 3:
                                ...
                                errorCallback(
                                  this.openvidu.generateAudioDeviceError(
                                    error_4,
                                    constraints,
                                  ),
                                );
                        ...
                        return __awaiter(_this, void 0, void 0, function () {
                          ...
                          return __generator(this, function (_b) {
                            switch (_b.label) {
                              case 0:
                                logger.error(
                                  "getMediaError: ".concat(error.toString()),
                                );
                                this.clearPermissionDialogTimer(
                                  startTime,
                                  timeForDialogEvent,
                              ...
                              case 7:
                                ...
                                if (
                                  error.constraint.toLowerCase() === "deviceid"
                                ) {
                                  errorName =
                                    OpenViduError_1.OpenViduErrorName
                                      .INPUT_AUDIO_DEVICE_NOT_FOUND;
                              ...
                              case 8:
                                error_6 = _b.sent();
                                if (
                                  error_6.constraint.toLowerCase() ===
                                  "deviceid"
                                ) {
                                  errorName =
                                    OpenViduError_1.OpenViduErrorName
                    ...
                    case 2:
                      ...
                      if (
                        ...
                        return [3, 3];
                      successCallback(
                        this.openvidu.addAlreadyProvidedTracks(
                          myConstraints,
                          new MediaStream(),
                          this.stream,
                        ),
                    ...
                    case 3:
                      ...
                      this.stream.setOutboundStreamOptions(
                        outboundStreamOptions,
                      );
                      definedAudioConstraint =
                        constraints.audio === undefined
                          ? true
                          : constraints.audio;
                      constraintsAux.audio = this.stream.isSendScreen()
                        ? false
                        : definedAudioConstraint;
                    ...
                    case 6:
                      ...
                      return [3, 10];
                    case 7:
                      this.stream.lastVideoTrackConstraints =
                        constraintsAux.video;
                      return [
                        4,
                        navigator.mediaDevices.getUserMedia(constraintsAux),
                      ];
          ...
          Publisher.prototype.replaceTrackAux = function (
            track,
            updateLastConstraints,
          ) {
            return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    this.replaceTrackInMediaStream(
                      track,
                      updateLastConstraints,
                    );
          ...
          Publisher.prototype.getVideoDimensions = function () {
            ...
            return new Promise(function (resolve, reject) {
              ...
              var resolveDimensions = function () {
                ...
                var height;
                if (
                  typeof _this.stream.getMediaStream().getVideoTracks()[0]
                    .getSettings === "function"
                ) {
                  var settings = _this.stream
                    .getMediaStream()
                    .getVideoTracks()[0]
                    .getSettings();
                  ...
                  logger.warn(
                    "MediaStreamTrack does not have getSettings method on " +
                ...
                if (loadedmetadataListener != null) {
                  _this.videoReference.removeEventListener(
                    "loadedmetadata",
          ...
          Publisher.prototype.initializeVideoReference = function (
            mediaStream,
          ) {
            ...
            if (!!this.firstVideoElement) {
              this.createVideoElement(
                this.firstVideoElement.targetElement,
                this.properties.insertMode,
              );
            }
            this.videoReference.srcObject = this.stream.getMediaStream();
          };
          Publisher.prototype.replaceTrackInMediaStream = function (
            track,
            updateLastConstraints,
          ) {
            ...
            var trackInfo = {
              oldLabel:
                (removedTrack === null || removedTrack === void 0
                  ? void 0
                  : removedTrack.label) || "",
              newLabel:
                (track === null || track === void 0 ? void 0 : track.label) ||
                "",
            };
            if (track.kind === "video" && updateLastConstraints) {
              this.openvidu.sendNewVideoDimensionsIfRequired(
                this,
                "trackReplaced",
                50,
                30,
              );
              this.openvidu.sendTrackChangedEvent(
                this,
                "trackReplaced",
                trackInfo.oldLabel,
                trackInfo.newLabel,
      ...
      {
        "../OpenViduInternal/Enums/OpenViduError": 52,
        "../OpenViduInternal/Enums/TypeOfVideo": 53,
        "../OpenViduInternal/Events/StreamEvent": 65,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 67,
        "../OpenViduInternal/Logger/OpenViduLogger": 79,
        "../OpenViduInternal/Utils/Platform": 83,
        "./Session": 47,
    ...
    47: [
      function (require, module, exports) {
        ...
        var Session = (function (_super) {
              ...
              if (!_this.sessionConnected()) {
                ...
                _this.openvidu.sendRequest(
                  ...
                  function (error, response) {
                    if (error) {
                      logger.error(
                        "Error unsubscribing from " + connectionId_1,
                      );
                      return reject(error);
                    } else {
                      logger.info(
                        "Unsubscribed correctly from " + connectionId_1,
                      );
          ...
          Session.prototype.on = function (type, handler) {
            ...
            if (type === "publisherStartSpeaking") {
              this.remoteConnections.forEach(function (remoteConnection) {
                var _a;
                if (
                  !!((_a = remoteConnection.stream) === null || _a === void 0
                    ? void 0
                    : _a.hasAudio)
                ) {
              ...
              if (
                ...
                this.remoteConnections.forEach(function (remoteConnection) {
                  ...
                  if (
                    ...
                    if (
                      !_this.anySpeechEventListenerEnabled(
                        "publisherStartSpeaking",
                        false,
                        remoteConnection.stream.streamManager,
                      )
                    ) {
              ...
              if (
                ...
                this.remoteConnections.forEach(function (remoteConnection) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      remoteConnection.stream.disableHarkStoppedSpeakingEvent(
                        false,
                      );
                    }
                  }
                ...
                if (
                  ...
                  if (
                    ...
                    this.connection.stream.disableHarkStoppedSpeakingEvent(
                      false,
                    );
                  }
                }
          ...
          Session.prototype.onNewMessage = function (event) {
            ...
            var strippedType = !!event.type
              ? event.type.replace(/^(signal:)/, "")
              : undefined;
            if (!!event.from) {
              this.getConnection(
                event.from,
          ...
          Session.prototype.onStreamPropertyChanged = function (event) {
            ...
            var callback = function (connection) {
              if (
                !!connection.stream &&
                connection.stream.streamId === event.streamId
              ) {
                var stream = connection.stream;
                var oldValue = void 0;
          ...
          Session.prototype.onConnectionPropertyChanged = function (event) {
            ...
            this.ee.emitEvent("connectionPropertyChanged", [
              new ConnectionPropertyChangedEvent_1.ConnectionPropertyChangedEvent(
                this,
                this.connection,
                event.property,
                event.newValue,
          ...
          Session.prototype.onNetworkQualityLevelChangedChanged = function (
            event,
          ) {
            var _this = this;
            if (event.connectionId === this.connection.connectionId) {
              this.ee.emitEvent("networkQualityLevelChanged", [
                new NetworkQualityLevelChangedEvent_1.NetworkQualityLevelChangedEvent(
                  this,
                  event.newValue,
                  event.oldValue,
                  this.connection,
              ...
              this.getConnection(
                event.connectionId,
                "Connection not found for connectionId " + event.connectionId,
              )
                .then(function (connection) {
          ...
          Session.prototype.onSessionClosed = function (msg) {
            ...
            var s = msg.sessionId;
            if (s !== undefined) {
              this.ee.emitEvent("session-closed", [{ session: s }]);
            } else {
          ...
          Session.prototype.onFilterEventDispatched = function (event) {
            ...
            this.getConnection(
              ...
              if (!stream || !stream.filter) {
                return logger.error(
                  'Filter event of type "'
                    .concat(event.eventType, '" dispatched for stream ')
                    .concat(stream.streamId, " but there is no ")
                    .concat(!stream ? "stream" : "filter", " defined"),
                );
              }
              ...
              if (!eventHandler || typeof eventHandler !== "function") {
                ...
                return logger.error(
                  'Filter event of type "'
                    .concat(
                      event.eventType,
                      '" not handled or not a function! Active filter events: ',
                    )
                    .concat(actualHandlers.join(",")),
                );
              } else {
                eventHandler.call(
                  _this,
              ...
              _this
                ...
                .then(function (connection) {
                  if (
                    ...
                    if (
                      stream_1.setupReconnectionEventEmitter(resolve, reject)
                    ) {
                      if (
                        ...
                        var callback_1 = function () {
                          ...
                          delete stream_1.reconnectionEventEmitter[
                            "onForciblyReconnectSubscriberLastEvent"
                          ];
                          _this.onForciblyReconnectSubscriber(eventAux);
                        };
                        stream_1.reconnectionEventEmitter.once(
                          "success",
                          function () {
                            callback_1();
                          },
                    ...
                    stream_1
                      ...
                      .then(function () {
                        return stream_1.finalResolveForSubscription(
                          true,
                          resolve,
                        );
                      })
                      .catch(function (error) {
                        return stream_1.finalRejectForSubscription(
                          true,
                          "Error while forcibly reconnecting remote stream "
                            .concat(event.streamId, ": ")
          ...
          Session.prototype.reconnectBrokenStreams = function () {
            ...
            this.remoteConnections.forEach(function (remoteConnection) {
              if (
                ...
                logger.warn(
                  "Re-establishing Subscriber " +
                    remoteConnection.stream.streamId,
                );
            ...
            if (!someReconnection) {
              logger.info(
                "There were no media streams in need of a reconnection",
              );
            }
          };
              ...
              if (!this.connection.disposed && !forced) {
                this.openvidu.sendRequest(
                  ...
                  function (error, response) {
                    if (error) {
                      logger.error(
                        "leaveRoom error: ".concat(JSON.stringify(error)),
                      );
                    }
          ...
          Session.prototype.sendVideoData = function (
            streamManager,
            intervalSeconds,
            doInterval,
            maxLoops,
            ...
            if (
                            ...
                            "videoData",
                            {
                              ...
                              videoActive:
                                streamManager.stream.videoActive != null
                                  ...
                                  : false,
                              audioActive:
                                streamManager.stream.audioActive != null
              ...
              if (doInterval) {
                ...
                this.videoDataTimeout = setTimeout(
                  obtainAndSendVideo_1,
                  intervalSeconds * 1e3,
                );
              }
              ...
              this.openvidu.sendRequest(
                ...
                {
                  height:
                    ((_a = streamManager.stream.videoDimensions) === null ||
                    _a === void 0
                      ? void 0
                      : _a.height) || 0,
                  width:
                    ((_b = streamManager.stream.videoDimensions) === null ||
                    _b === void 0
                      ? void 0
                      : _b.width) || 0,
                  videoActive:
          ...
          Session.prototype.notConnectedError = function () {
            return new OpenViduError_1.OpenViduError(
              OpenViduError_1.OpenViduErrorName.OPENVIDU_NOT_CONNECTED,
              "There is no connection to the session. Method 'Session.connect' must be successfully completed first",
            );
          };
          Session.prototype.anySpeechEventListenerEnabled = function (
            event,
            onlyOnce,
            streamManager,
          ) {
            ...
            if (!!streamManager) {
              var handlersInStreamManager =
                streamManager.ee.getListeners(event);
              if (onlyOnce) {
                handlersInStreamManager = handlersInStreamManager.filter(
                  function (h) {
                    return h.once;
                  },
                );
                    ...
                    function (error, response) {
                      if (!!error) {
                        ...
                        existingParticipants.forEach(
                          function (remoteConnectionOptions) {
                            var connection = new Connection_1.Connection(
                              _this,
                              remoteConnectionOptions,
                            );
                            _this.remoteConnections.set(
                              connection.connectionId,
                              connection,
                            );
                            events_1.connections.push(connection);
                            if (!!connection.stream) {
                              _this.remoteStreamsCreated.set(
          ...
          Session.prototype.processToken = function (token) {
            ...
            if (!!tokenParams.webrtcStatsInterval) {
              this.openvidu.webrtcStatsInterval =
                tokenParams.webrtcStatsInterval;
            }
            if (!!tokenParams.sendBrowserLogs) {
              this.openvidu.sendBrowserLogs = tokenParams.sendBrowserLogs;
            }
            this.openvidu.isAtLeastPro =
              tokenParams.edition === "pro" ||
              tokenParams.edition === "enterprise";
          ...
          Session.prototype.processJoinRoomResponse = function (opts, token) {
            ...
            if (
              opts.customIceServers != null &&
              opts.customIceServers.length > 0
            ) {
              this.openvidu.iceServers = [];
              for (
                var _i = 0, _a = opts.customIceServers;
                _i < _a.length;
                _i++
              ) {
                var iceServer = _a[_i];
                var rtcIceServer = { urls: [iceServer.url] };
                logger.log("STUN/TURN server IP: " + iceServer.url);
                if (
                  iceServer.username != null &&
                  iceServer.credential != null
                ) {
            ...
            var minorDifference =
              semverMinor(opts.version) -
              semverMinor(this.openvidu.libraryVersion);
            if (
              semverMajor(opts.version) !==
                semverMajor(this.openvidu.libraryVersion) ||
              !(minorDifference == 0 || minorDifference == 1)
            ) {
              logger.error(
                "openvidu-browser ("
                  .concat(
                  ...
                  .concat(opts.version, ") versions are incompatible. ") +
              ...
              logger.warn(
                "openvidu-browser version "
                  .concat(
                    this.openvidu.libraryVersion,
                    " does not match openvidu-server version ",
                  )
                  .concat(opts.version, ". ") +
                  "These versions are still compatible with each other, but openvidu-browser version must be updated as soon as possible to "
                    .concat(semverMajor(opts.version), ".")
                    .concat(semverMinor(opts.version), ".x. ") +
                  "This client using openvidu-browser ".concat(
                    this.openvidu.libraryVersion,
                    " will become incompatible with the next release of openvidu-server",
                  ),
              );
            }
            OpenViduLogger_1.OpenViduLogger.configureJSNLog(
              this.openvidu,
              token,
            );
            this.token = token;
      ...
      },
      {
        "../OpenViduInternal/Enums/OpenViduError": 52,
        "../OpenViduInternal/Enums/VideoInsertMode": 54,
        "../OpenViduInternal/Events/ConnectionEvent": 55,
        "../OpenViduInternal/Events/ConnectionPropertyChangedEvent": 56,
        "../OpenViduInternal/Events/FilterEvent": 59,
        "../OpenViduInternal/Events/NetworkQualityLevelChangedEvent": 60,
        "../OpenViduInternal/Events/RecordingEvent": 62,
        "../OpenViduInternal/Events/SessionDisconnectedEvent": 63,
        "../OpenViduInternal/Events/SignalEvent": 64,
        "../OpenViduInternal/Events/StreamEvent": 65,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 67,
        "../OpenViduInternal/Logger/OpenViduLogger": 79,
        "../OpenViduInternal/Utils/Platform": 83,
        ...
        "./Filter": 43,
        "./Subscriber": 50,
        "semver/functions/major": 15,
        "semver/functions/minor": 16,
      },
    ],
    48: [
      function (require, module, exports) {
        ...
        var Stream = (function () {
          function Stream(session, options) {
            ...
            if (options.hasOwnProperty("id")) {
              ...
              if (this.hasAudio) {
                this.audioActive =
                  !!this.outboundStreamOpts.publisherProperties.publishAudio;
              }
              if (this.hasVideo) {
                this.videoActive =
                  !!this.outboundStreamOpts.publisherProperties.publishVideo;
                this.frameRate =
                  this.outboundStreamOpts.publisherProperties.frameRate;
                if (
                  typeof MediaStreamTrack !== "undefined" &&
            ...
            this.ee.on("mediastream-updated", function () {
              ...
              logger.debug(
                "Video srcObject [" +
                  ((_a = _this.mediaStream) === null || _a === void 0
                    ? void 0
                    : _a.id) +
                  "] updated in stream [" +
                  _this.streamId +
                ...
                return __generator(this, function (_a) {
                  if (!!this.filter) {
                    return [
                      ...
                      reject(
                        new OpenViduError_1.OpenViduError(
                          OpenViduError_1.OpenViduErrorName.GENERIC_ERROR,
                          "There is already a filter applied to Stream " +
                            this.streamId,
                        ),
                      ),
                    ];
                  ...
                  resolveApplyFilter = function (error, triggerEvent) {
                    if (error) {
                      ...
                      logger.info(
                        "Filter successfully applied on Stream " +
                          _this.streamId,
                      );
                  ...
                  if (type.startsWith("VB:")) {
                    ...
                    if (
                      !this.mediaStream ||
                      this.streamManager.videos.length === 0
                    ) {
                      return [
                        2,
                        reject(
                    ...
                    tokenParams_1 =
                      this.session.getTokenParams(openviduToken_1);
                    if (
                      tokenParams_1.edition !== "pro" &&
                      tokenParams_1.edition !== "enterprise"
                    ) {
                      return [
                        2,
                        reject(
                    ...
                    logger.info(
                      "Applying Virtual Background to stream " + this.streamId,
                    );
                        ...
                        return __generator(this, function (_b) {
                          switch (_b.label) {
                            case 0:
                              ...
                              videoClone =
                                this.streamManager.videos[0].video.cloneNode(
                                  false,
                                );
                              videoClone.id =
                                VirtualBackground.VirtualBackground
                                  .SOURCE_VIDEO_PREFIX + id;
                              ...
                              VirtualBackground.VirtualBackground.hideHtmlElement(
                                videoClone,
                                false,
                              );
                            ...
                            case 1:
                              ...
                              VB = new VirtualBackground.VirtualBackground({
                                id: id,
                                openviduServerUrl: new URL(
                                  tokenParams_1.httpUri,
                                ),
                            ...
                            case 6:
                              throw new Error(
                                "Unknown Virtual Background filter: " + type,
                              );
                            case 7:
                    ...
                    logger.info(
                      "Applying server filter to stream " + this.streamId,
                    );
                    ...
                    case 0:
                      resolveRemoveFilter = function (error, triggerEvent) {
                        if (error) {
                          delete _this.filter;
                          logger.error(
                            "Error removing filter for Stream " +
                              _this.streamId,
                            error,
                          );
                          if (error.code === 401) {
                      ...
                      if (
                        !((_a = this.filter) === null || _a === void 0
                          ? void 0
                          : _a.type.startsWith("VB:"))
                      )
                        return [3, 9];
                      _b.label = 1;
                    case 1:
                      _b.trys.push([1, 7, , 8]);
                      mediaStreamClone =
                        this.virtualBackgroundSourceElements.mediaStreamClone;
                      if (!!isDisposing) return [3, 5];
                      if (!this.streamManager.remote) return [3, 2];
                      this.streamManager.replaceTrackInMediaStream(
                        mediaStreamClone.getVideoTracks()[0],
                        false,
                      );
                      return [3, 4];
                    case 2:
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  ...
                  case 2:
                    _a.sent();
                    console.debug(
                      "Success removing Virtual Background filter for stream ".concat(
                        this.streamId,
                      ),
                    );
                    return [3, 4];
                  case 3:
                    error_4 = _a.sent();
                    console.error(
                      "Error removing Virtual Background filter for stream ".concat(
                        this.streamId,
                      ),
                      error_4,
                    );
          ...
          Stream.prototype.disableHarkSpeakingEvent = function (
            disabledByOnce,
          ) {
            if (!!this.speechEvent) {
              this.harkSpeakingEnabledOnce = false;
          ...
          Stream.prototype.disableHarkStoppedSpeakingEvent = function (
            disabledByOnce,
          ) {
            if (!!this.speechEvent) {
              this.harkStoppedSpeakingEnabledOnce = false;
          ...
          Stream.prototype.disableHarkVolumeChangeEvent = function (
            disabledByOnce,
          ) {
            if (!!this.speechEvent) {
              this.harkVolumeChangeEnabledOnce = false;
          ...
          Stream.prototype.streamIceConnectionStateBroken = function () {
            ...
            var iceConnectionState =
              this.getRTCPeerConnection().iceConnectionState;
            return (
          ...
          Stream.prototype.setupReconnectionEventEmitter = function (
            resolve,
            reject,
          ) {
          ...
          Stream.prototype.initWebRtcPeerSend = function (reconnect) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              var finalResolve = function () {
                var _a;
                if (reconnect) {
                  (_a = _this.reconnectionEventEmitter) === null ||
                  _a === void 0
                    ? void 0
                    : _a.emitEvent("success");
              ...
              var successOfferCallback = function (sdpOfferParam) {
                ...
                var params;
                if (reconnect) {
                  params = { stream: _this.streamId, sdpString: sdpOfferParam };
                } else {
                    ...
                    if (error) {
                      ...
                      _this.webRtcPeer
                        ...
                        .then(function () {
                          ...
                          if (reconnect) {
                            _this.ee.emitEvent(
                              "stream-reconnected-by-publisher",
                              [],
                            );
                          } else {
                            _this.ee.emitEvent(
              ...
              var config = {
                ...
                simulcast:
                  (_a =
                    _this.outboundStreamOpts.publisherProperties
                      .videoSimulcast) !== null && _a !== void 0
                    ? _a
                    : _this.session.openvidu.videoSimulcast,
                onIceCandidate: _this.connection.sendIceCandidate.bind(
                  _this.connection,
                ),
                onIceConnectionStateException: function (
                  exceptionName,
                  message,
                  data,
                ) {
                ...
                typeOfVideo: _this.typeOfVideo
                  ? TypeOfVideo_1.TypeOfVideo[_this.typeOfVideo]
                  : undefined,
              };
              ...
              _this.webRtcPeer
                ...
                .then(function (sdpOffer) {
                  _this.webRtcPeer
                    ...
                    .catch(function (error) {
                      finalReject(
                        new Error(
                          "(publish) SDP process local offer error: " +
                ...
                .catch(function (error) {
                  finalReject(
                    new Error(
                      "(publish) SDP create offer error: " +
                        JSON.stringify(error),
                    ),
                  );
                });
          ...
          Stream.prototype.finalResolveForSubscription = function (
            reconnect,
            resolve,
          ) {
            var _a;
            ...
            if (reconnect) {
              (_a = this.reconnectionEventEmitter) === null || _a === void 0
                ? void 0
                : _a.emitEvent("success");
          ...
          Stream.prototype.finalRejectForSubscription = function (
            reconnect,
            error,
            reject,
          ) {
          ...
          Stream.prototype.initWebRtcPeerReceive = function (reconnect) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              if (_this.session.openvidu.mediaServer === "mediasoup") {
                _this
                  .initWebRtcPeerReceiveFromServer(reconnect)
                  .then(function () {
                    return _this.finalResolveForSubscription(
                      reconnect,
                      resolve,
                    );
                  })
                  .catch(function (error) {
                    return _this.finalRejectForSubscription(
                      reconnect,
                      error,
                      reject,
                    );
          ...
          Stream.prototype.initWebRtcPeerReceiveFromClient = function (
            reconnect,
          ) {
            var _this = this;
            return new Promise(function (resolve, reject) {
              _this
                .completeWebRtcPeerReceive(reconnect, false)
          ...
          Stream.prototype.initWebRtcPeerReceiveFromServer = function (
            reconnect,
          ) {
            var _this = this;
            return new Promise(function (resolve, reject) {
              _this.session.openvidu.sendRequest(
                ...
                { sender: _this.streamId, reconnect: reconnect },
                function (error, response) {
                  if (error) {
                    return reject(
                      new Error(
                        "Error on prepareReceiveVideoFrom: " +
                          JSON.stringify(error),
                      ),
                    );
                  } else {
          ...
          Stream.prototype.completeWebRtcPeerReceive = function (
            reconnect,
            forciblyReconnect,
            sdpOfferByServer,
          ) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              var sendSdpToServer = function (sdpString) {
                logger.debug(
                  "Sending local SDP "
                    .concat(
                      !!sdpOfferByServer ? "answer" : "offer",
                      " to subscribe to ",
                    )
                    .concat(_this.streamId),
                  sdpString,
                );
                ...
                _this.session.openvidu.sendRequest(
                  ...
                  function (error, response) {
                    if (error) {
                      return reject(
                        new Error(
                          "Error on " + method + " : " + JSON.stringify(error),
                        ),
                      );
                    } else {
              ...
              if (!!sdpOfferByServer) {
                _this.webRtcPeer
                  ...
                  .then(function () {
                    _this.webRtcPeer
                      ...
                      .catch(function (error) {
                        return reject(
                          new Error(
                            "(subscribe) SDP create answer error: " +
                              JSON.stringify(error),
                          ),
                        );
                      });
                  ...
                  .catch(function (error) {
                    return reject(
                      new Error(
                        "(subscribe) SDP process remote offer error: " +
                          JSON.stringify(error),
                      ),
                    );
                  });
                ...
                _this.webRtcPeer
                  ...
                  .catch(function (error) {
                    return reject(
                      new Error(
                        "(subscribe) SDP create offer error: " +
                          JSON.stringify(error),
                      ),
                    );
                  });
            ...
            if (!!this.mediaStream) {
              if (this.streamManager instanceof Subscriber_1.Subscriber) {
                if (!!this.mediaStream.getAudioTracks()[0]) {
                  var enabled = reconnect
                    ? this.audioActive
                    : !!this.streamManager.properties.subscribeToAudio;
                  this.mediaStream.getAudioTracks()[0].enabled = enabled;
                }
                if (!!this.mediaStream.getVideoTracks()[0]) {
                  var enabled = reconnect
                    ? this.videoActive
                    : !!this.streamManager.properties.subscribeToVideo;
          ...
          Stream.prototype.initHarkEvents = function () {
            if (!!this.mediaStream.getAudioTracks()[0]) {
              if (
                this.session.anySpeechEventListenerEnabled(
                  "publisherStartSpeaking",
                  true,
                  this.streamManager,
                )
          ...
          Stream.prototype.onIceConnectionStateExceptionHandler = function (
            exceptionName,
            message,
            data,
          ) {
            switch (exceptionName) {
              case ExceptionEvent_1.ExceptionEventName.ICE_CONNECTION_FAILED:
                ...
                break;
              case ExceptionEvent_1.ExceptionEventName
          ...
          Stream.prototype.onIceConnectionFailed = function () {
            logger.log(
              "[ICE_CONNECTION_FAILED] Handling ICE_CONNECTION_FAILED event. Reconnecting stream "
                .concat(this.streamId, " (")
                .concat(this.isLocal() ? "Publisher" : "Subscriber", ")"),
            );
            this.reconnectStreamAndLogResultingIceConnectionState(
              ExceptionEvent_1.ExceptionEventName.ICE_CONNECTION_FAILED,
            );
          };
          Stream.prototype.onIceConnectionDisconnected = function () {
            ...
            var timeout =
              this.session.openvidu.advancedConfiguration
                .iceConnectionDisconnectedExceptionTimeout || 4e3;
            this.awaitWebRtcPeerConnectionState(timeout).then(function (state) {
              switch (state) {
                case "failed":
                  logger.warn(
                    "[ICE_CONNECTION_DISCONNECTED] ICE connection of stream "
                      .concat(_this.streamId, " (")
                      .concat(
                        _this.isLocal() ? "Publisher" : "Subscriber",
                ...
                case "completed":
                  logger.log(
                    "[ICE_CONNECTION_DISCONNECTED] ICE connection of stream "
                      ...
                      .concat(
                        _this.isLocal() ? "Publisher" : "Subscriber",
                        ") automatically restored after ICE_CONNECTION_DISCONNECTED. Current ICE connection state: ",
                      )
                      .concat(state),
                  );
                  break;
                ...
                case "disconnected":
                  logger.warn(
                    "[ICE_CONNECTION_DISCONNECTED] ICE connection of stream "
                      ...
                      .concat(
                        _this.isLocal() ? "Publisher" : "Subscriber",
                        ") couldn't be restored after ICE_CONNECTION_DISCONNECTED event. Current ICE connection state after ",
                      )
                      .concat(timeout, " ms: ")
                      .concat(state),
                  );
                  _this.reconnectStreamAndLogResultingIceConnectionState(
                    ExceptionEvent_1.ExceptionEventName
                      .ICE_CONNECTION_DISCONNECTED,
                  );
                  break;
              }
          ...
          Stream.prototype.reconnectStreamAndLogResultingIceConnectionState =
            function (event) {
              return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                  switch (_a.label) {
                        ...
                        case "completed":
                          logger.log(
                            "["
                              ...
                              .concat(event, ". Current ICE connection state: ")
                              .concat(finalIceStateAfterReconnection),
                          );
                          break;
                        default:
                          logger.error(
                    ...
                    case 2:
                      ...
                      logger.error(
                        "["
                          .concat(event, "] Error reconnecting stream ")
                          .concat(this.streamId, " (")
                          .concat(
                            this.isLocal() ? "Publisher" : "Subscriber",
                            ") after ",
          ...
          Stream.prototype.reconnectStreamAndReturnIceConnectionState =
            function (event) {
              return __awaiter(this, void 0, void 0, function () {
                var timeout, error_6;
                return __generator(this, function (_a) {
                  switch (_a.label) {
                    case 0:
                      logger.log(
                        "["
                          .concat(event, "] Reconnecting stream ")
                          .concat(this.streamId, " (")
                          .concat(
                            this.isLocal() ? "Publisher" : "Subscriber",
                            ") after event ",
                ...
                switch (_a.label) {
                  ...
                  case 1:
                    ...
                    if (isWsConnected) {
                      logger.log(
                        "["
                          .concat(event, "] Trying to reconnect stream ")
                          .concat(this.streamId, " (")
                          .concat(
                            this.isLocal() ? "Publisher" : "Subscriber",
          ...
          Stream.prototype.isWebsocketConnected = function (
            event,
            msResponseTimeout,
          ) {
            var _this = this;
            return new Promise(function (resolve, reject) {
              ...
              if (wsReadyState === 1) {
                var responseTimeout_1 = setTimeout(function () {
                  console.warn(
                    "["
                      .concat(event, "] Websocket timeout of ")
                      .concat(msResponseTimeout, "ms"),
                  );
                ...
                _this.session.openvidu.sendRequest(
                  ...
                  function (error, response) {
                    ...
                    if (!!error) {
                      console.warn(
                        "["
                          .concat(event, "] Websocket 'echo' returned error: ")
                          .concat(error),
                      );
                      return resolve(false);
                    } else {
                ...
                console.warn(
                  "["
                    .concat(event, "] Websocket readyState is ")
                    .concat(wsReadyState),
                );
                return resolve(false);
              }
      ...
      },
      {
        ...
        "../OpenViduInternal/Enums/TypeOfVideo": 53,
        "../OpenViduInternal/Events/ExceptionEvent": 58,
        "../OpenViduInternal/Events/PublisherSpeakingEvent": 61,
        "../OpenViduInternal/Events/StreamManagerEvent": 66,
        "../OpenViduInternal/Events/StreamPropertyChangedEvent": 67,
        "../OpenViduInternal/Logger/OpenViduLogger": 79,
        "../OpenViduInternal/Utils/Platform": 83,
        "../OpenViduInternal/WebRtcPeer/WebRtcPeer": 84,
        "../OpenViduInternal/WebRtcStats/WebRtcStats": 85,
        "./Filter": 43,
        "./Subscriber": 50,
        hark: 5,
        uuid: 22,
    ...
    49: [
      function (require, module, exports) {
        ...
        var StreamManager = (function (_super) {
          ...
          StreamManager.prototype.off = function (type, handler) {
            ...
            if (type === "publisherStartSpeaking") {
              var remainingStartSpeakingEventListeners =
                this.ee.getListeners(type).length +
                this.stream.session.ee.getListeners(type).length;
              if (remainingStartSpeakingEventListeners === 0) {
                this.stream.disableHarkSpeakingEvent(false);
              }
            }
            if (type === "publisherStopSpeaking") {
              var remainingStopSpeakingEventListeners =
                this.ee.getListeners(type).length +
                this.stream.session.ee.getListeners(type).length;
            ...
            if (type === "streamAudioVolumeChange") {
              var remainingVolumeEventListeners =
                this.ee.getListeners(type).length;
          ...
          StreamManager.prototype.addVideoElement = function (video) {
            ...
            this.stream.session.streamManagers.forEach(
          ...
          StreamManager.prototype.updatePublisherSpeakingEventsOptions =
            function (publisherSpeakingEventsOptions) {
          ...
          StreamManager.prototype.removeSrcObject = function (
            streamManagerVideo,
          ) {
          ...
          StreamManager.prototype.activateStreamPlayingEventExceptionTimeout =
            function () {
              var _this = this;
              if (!this.remote) {
                return;
              ...
              var msTimeout =
                this.stream.session.openvidu.advancedConfiguration
                  .noStreamPlayingEventExceptionTimeout || 4e3;
              this.streamPlayingEventExceptionTimeout = setTimeout(function () {
                ...
                _this.stream.session.emitEvent("exception", [
                  new ExceptionEvent_1.ExceptionEvent(
                    _this.stream.session,
                    ExceptionEvent_1.ExceptionEventName.NO_STREAM_PLAYING_EVENT,
                    _this,
                    msg,
                  ),
                ]);
          ...
          StreamManager.prototype.deactivateStreamPlayingEventExceptionTimeout =
            function () {
      ...
      },
      {
        ...
        "../OpenViduInternal/Events/ExceptionEvent": 58,
        "../OpenViduInternal/Events/StreamManagerEvent": 66,
        "../OpenViduInternal/Events/VideoElementEvent": 68,
        "../OpenViduInternal/Logger/OpenViduLogger": 79,
        "../OpenViduInternal/Utils/Platform": 83,
        "./EventDispatcher": 42,
      },
    ...
    50: [
      function (require, module, exports) {
        ...
        var Subscriber = (function (_super) {
          ...
          Subscriber.prototype.replaceTrackInMediaStream = function (
            track,
            updateLastConstraints,
          ) {
    ...
    56: [
      function (require, module, exports) {
        ...
        var ConnectionPropertyChangedEvent = (function (_super) {
          ...
          function ConnectionPropertyChangedEvent(
            target,
            connection,
            changedProperty,
            newValue,
            ...
            var _this =
              _super.call(this, false, target, "connectionPropertyChanged") ||
              this;
            _this.connection = connection;
          ...
          ConnectionPropertyChangedEvent.prototype.callDefaultBehavior =
            function () {};
    ...
    58: [
      function (require, module, exports) {
        ...
        (function (ExceptionEventName) {
          ...
          ExceptionEventName["ICE_CONNECTION_DISCONNECTED"] =
            "ICE_CONNECTION_DISCONNECTED";
          ExceptionEventName["NO_STREAM_PLAYING_EVENT"] =
            "NO_STREAM_PLAYING_EVENT";
        })(
          (ExceptionEventName =
            exports.ExceptionEventName || (exports.ExceptionEventName = {})),
        );
      ...
      function (require, module, exports) {
        ...
        var NetworkQualityLevelChangedEvent = (function (_super) {
          ...
          function NetworkQualityLevelChangedEvent(
            ...
            var _this =
              _super.call(this, false, target, "networkQualityLevelChanged") ||
              this;
            _this.newValue = newValue;
            _this.oldValue = oldValue;
            _this.connection = connection;
          ...
          NetworkQualityLevelChangedEvent.prototype.callDefaultBehavior =
            function () {};
          return NetworkQualityLevelChangedEvent;
        })(Event_1.Event);
        exports.NetworkQualityLevelChangedEvent =
    ...
    63: [
        ...
        var SessionDisconnectedEvent = (function (_super) {
          ...
          SessionDisconnectedEvent.prototype.callDefaultBehavior = function () {
            ...
            session.remoteConnections.forEach(function (remoteConnection) {
              ...
              if (
                !!((_a = session.remoteConnections.get(connectionId)) ===
                  null || _a === void 0
                  ? void 0
                  : _a.stream)
              ) {
                (_b = session.remoteConnections.get(connectionId)) === null ||
                _b === void 0
                  ? void 0
                  : _b.stream.disposeWebRtcPeer();
                (_c = session.remoteConnections.get(connectionId)) === null ||
                _c === void 0
                  ? void 0
                  : _c.stream.disposeMediaStream();
                if (
                  (_d = session.remoteConnections.get(connectionId)) === null ||
                  _d === void 0
                    ? void 0
                    : _d.stream.streamManager
                ) {
                  (_e = session.remoteConnections.get(connectionId)) === null ||
                  _e === void 0
                    ? void 0
                    : _e.stream.streamManager.removeAllVideos();
                }
                var streamId =
                  (_g =
                    (_f = session.remoteConnections.get(connectionId)) ===
                      null || _f === void 0
                      ? void 0
                      : _f.stream) === null || _g === void 0
                    ? void 0
                    : _g.streamId;
                if (!!streamId) {
                  session.remoteStreamsCreated.delete(streamId);
                }
                (_h = session.remoteConnections.get(connectionId)) === null ||
                _h === void 0
                  ? void 0
                  : _h.dispose();
              }
      ...
      { "../Logger/OpenViduLogger": 79, "./Event": 57 },
    ],
    64: [
      function (require, module, exports) {
        "use strict";
    ...
    65: [
        ...
        var StreamEvent = (function (_super) {
          ...
          StreamEvent.prototype.callDefaultBehavior = function () {
            if (this.type === "streamDestroyed") {
              ...
              this.stream.session.remoteStreamsCreated.delete(
                this.stream.streamId,
              );
              var remoteConnection = this.stream.session.remoteConnections.get(
                this.stream.connection.connectionId,
              );
              if (!!remoteConnection && !!remoteConnection.remoteOptions) {
                var streamOptionsServer =
                  remoteConnection.remoteOptions.streams;
      ...
      {
        "../../OpenVidu/Publisher": 46,
        "../../OpenVidu/Session": 47,
        "../Logger/OpenViduLogger": 79,
        "./Event": 57,
      },
    ],
    66: [
    ...
    67: [
      function (require, module, exports) {
        ...
        var StreamPropertyChangedEvent = (function (_super) {
          ...
          StreamPropertyChangedEvent.prototype.callDefaultBehavior =
            function () {};
    ...
    71: [
      function (require, module, exports) {
        ...
        var OpenViduLogger =
          require("../../../Logger/OpenViduLogger").OpenViduLogger;
        Date.now =
          Date.now ||
          function () {
            return +new Date();
          ...
          function sendPing() {
            if (enabledPings) {
              ...
              if (
                ...
                params = { interval: configuration.heartbeat || PING_INTERVAL };
              }
              pingNextNum++;
              self.send(
                "ping",
      ...
      },
      {
        "../": 74,
        "../../../Logger/OpenViduLogger": 79,
        "./transports/webSocketWithReconnection": 73,
      },
    ],
    72: [
      function (require, module, exports) {
            ...
            if (ws.readyState === CLOSED) {
              if (closing) {
                ...
                if (config.ismasternodecrashed()) {
                  Logger.error(
                    "Master Node has crashed. Stopping reconnection process",
                  );
                } else {
                  Logger.debug(
      ...
      function (require, module, exports) {
        ...
        function unifyResponseMethods(responseMethods) {
          ...
          for (var key in responseMethods) {
            ...
            if (typeof value == "string")
              responseMethods[key] = { response: value };
          }
        ...
        function RpcBuilder(packer, options, transport, onRequest) {
          ...
          if (options instanceof Function) {
            if (transport != undefined)
              throw new SyntaxError(
                "There can't be parameters after onRequest",
              );
            onRequest = options;
            transport = undefined;
            options = undefined;
              ...
              if (error || result != undefined) {
                ...
                if (responseMethod) {
                  if (responseMethod.error == undefined && error)
                    ...
                    message = { method: method, params: error || result };
                  }
                } else message = { error: error, result: result };
          ...
          this.encode = function (method, params, dest, transport, callback) {
            ...
            if (callback) {
              ...
              function sendRequest(transport) {
                ...
                transport =
                  transport || encode_transport || self.getTransport();
                if (transport) return transport.send(message);
                return message;
              }
    ...
    79: [
      function (require, module, exports) {
        ...
        var OpenViduLogger = (function () {
          function OpenViduLogger() {
            ...
            this.defaultConsoleLogger = new ConsoleLogger_1.ConsoleLogger(
              globalThis.console,
            );
          ...
          OpenViduLogger.configureJSNLog = function (openVidu, token) {
            ...
            try {
              if (
                ...
                if (
                  openVidu.sendBrowserLogs ===
                  OpenViduLoggerConfiguration_1.OpenViduLoggerConfiguration
                    .debug_app
                ) {
                ...
                var beforeSendCallback = function (xhr) {
                  ...
                  xhr.setRequestHeader(
                    ...
                    "Basic " +
                      btoa(
                        "".concat(finalUserId_1, "%/%").concat(sessionId_1) +
                          ":" +
                          token,
                      ),
                  );
                ...
                this.instance.currentAppender = jsnlog_1.JL.createAjaxAppender(
                  "appender-".concat(finalUserId_1, "-").concat(sessionId_1),
                );
                ...
                var logSerializer = function (obj) {
                  ...
                  if (
                    stringifyJson.length > _this.instance.MAX_LENGTH_STRING_JSON
                  ) {
                    stringifyJson = "".concat(
                      stringifyJson.substring(
                        0,
                        _this.instance.MAX_LENGTH_STRING_JSON,
                      ),
                      "...",
                    );
                  }
          ...
          OpenViduLogger.prototype.canConfigureJSNLog = function (
            openVidu,
            logger,
          ) {
            return openVidu.session.sessionId != logger.loggingSessionId;
          };
          OpenViduLogger.prototype.isOpenViduBrowserLogsDebugActive = function (
            openVidu,
          ) {
            return (
              openVidu.sendBrowserLogs ===
            ...
            return (function (openViduLogger) {
              return {
                log: function () {
                  ...
                  openViduLogger.defaultConsoleLogger.log.apply(
                    openViduLogger.defaultConsoleLogger.logger,
                    arguments,
                  );
                ...
                info: function () {
                  ...
                  openViduLogger.defaultConsoleLogger.info.apply(
                    openViduLogger.defaultConsoleLogger.logger,
                    arguments,
                  );
                  if (openViduLogger.isJSNLogSetup) {
                ...
                debug: function () {
                  ...
                  openViduLogger.defaultConsoleLogger.debug.apply(
                    openViduLogger.defaultConsoleLogger.logger,
                    arguments,
                  );
                },
                warn: function () {
                  ...
                  openViduLogger.defaultConsoleLogger.warn.apply(
                    openViduLogger.defaultConsoleLogger.logger,
                    arguments,
                  );
                  if (openViduLogger.isJSNLogSetup) {
                ...
                error: function () {
                  ...
                  openViduLogger.defaultConsoleLogger.error.apply(
                    openViduLogger.defaultConsoleLogger.logger,
                    arguments,
                  );
                  if (openViduLogger.isJSNLogSetup) {
          ...
          OpenViduLogger.prototype.log = function () {
            ...
            if (!this.isProdMode) {
              this.defaultConsoleLogger.log.apply(
                this.defaultConsoleLogger.logger,
                arguments,
              );
            }
          ...
          OpenViduLogger.prototype.debug = function () {
            ...
            if (!this.isProdMode) {
              this.defaultConsoleLogger.debug.apply(
                this.defaultConsoleLogger.logger,
                arguments,
              );
            }
          ...
          OpenViduLogger.prototype.info = function () {
            ...
            if (!this.isProdMode) {
              this.defaultConsoleLogger.info.apply(
                this.defaultConsoleLogger.logger,
                arguments,
              );
            }
          ...
          OpenViduLogger.prototype.warn = function () {
            ...
            this.defaultConsoleLogger.warn.apply(
              this.defaultConsoleLogger.logger,
              arguments,
            );
            if (this.isJSNLogSetup) {
          ...
          OpenViduLogger.prototype.error = function () {
            ...
            this.defaultConsoleLogger.error.apply(
              this.defaultConsoleLogger.logger,
              arguments,
            );
            if (this.isJSNLogSetup) {
      ...
      { "./ConsoleLogger": 78, "./OpenViduLoggerConfiguration": 80, jsnlog: 7 },
    ],
    80: [
      function (require, module, exports) {
        "use strict";
        ...
        (function (OpenViduLoggerConfiguration) {
          ...
          (OpenViduLoggerConfiguration =
            exports.OpenViduLoggerConfiguration ||
            (exports.OpenViduLoggerConfiguration = {})),
        );
      },
      {},
    ...
    81: [
      function (require, module, exports) {
        globalThis.getScreenId = function (
          firefoxString,
          callback,
          custom_parameter,
        ) {
        ...
        function getScreenConstraints(error, sourceId, canRequestAudioTrack) {
          var screen_constraints = {
            ...
            video: {
              mandatory: {
                ...
                maxWidth:
                  globalThis.screen.width > 1920
                    ? globalThis.screen.width
                    : 1920,
                maxHeight:
                  globalThis.screen.height > 1080
          ...
          if (!!canRequestAudioTrack) {
            screen_constraints.audio = {
              mandatory: { chromeMediaSource: error ? "screen" : "desktop" },
              optional: [],
            };
          }
          if (sourceId) {
    ...
    82: [
      function (require, module, exports) {
        ...
        function getCustomSourceId(arr, callback) {
          ...
          if (sourceId) return callback(sourceId);
          screenCallback = callback;
          window.postMessage({ "get-custom-sourceId": arr }, "*");
        }
        ...
        var PlatformUtils = (function () {
          ...
          PlatformUtils.prototype.isEdgeMobileBrowser = function () {
            ...
            return (
              ...
              (((_a = platform.os) === null || _a === void 0
                ? void 0
                : _a.family) === "Android" ||
                ((_b = platform.os) === null || _b === void 0
                  ? void 0
                  : _b.family) === "iOS") &&
              version > 45
            );
          ...
          PlatformUtils.prototype.isIonicIos = function () {
            return (
              this.isIPhoneOrIPad() && platform.ua.indexOf("Safari") === -1
            );
          };
          PlatformUtils.prototype.isIonicAndroid = function () {
            return (
              platform.os.family === "Android" &&
              platform.name == "Android Browser"
            );
          };
    ...
    84: [
      function (require, module, exports) {
        ...
        exports.WebRtcPeerSendrecv =
          exports.WebRtcPeerSendonly =
          exports.WebRtcPeerRecvonly =
          exports.WebRtcPeer =
            void 0;
        ...
        var WebRtcPeer = (function () {
          ...
          WebRtcPeer.prototype.createOfferLegacy = function () {
            ...
            logger.debug(
              "[createOfferLegacy] RTCPeerConnection.createOffer() options:",
              ...
              return __generator(this, function (_m) {
                switch (_m.label) {
                  case 0:
                    ...
                    if (!this.configuration.mediaStream) {
                      throw new Error(
                        "[WebRtcPeer.createOffer] Direction is '".concat(
                          this.configuration.mode,
                          "', but no stream was configured to be sent",
                        ),
                      );
                    }
                  ...
                  case 1:
                    ...
                    if (
                      ...
                      trackWidth =
                        (_c =
                          (_b =
                            (_a = trackSettings.width) !== null && _a !== void 0
                              ? _a
                              : trackConsts.width.ideal) !== null &&
                          _b !== void 0
                            ? _b
                            : trackConsts.width) !== null && _c !== void 0
                          ? _c
                          : 0;
                      trackHeight =
                        (_f =
                          (_e =
                            (_d = trackSettings.height) !== null &&
                            _d !== void 0
                              ? _d
                              : trackConsts.height.ideal) !== null &&
                          _e !== void 0
                            ? _e
                            : trackConsts.height) !== null && _f !== void 0
                          ? _f
                          : 0;
                      logger.info(
                        "[createOffer] Video track dimensions: "
                          .concat(trackWidth, "x")
                          .concat(trackHeight),
                      );
                    ...
                    needSetParams = false;
                    if (
                      !((_g = sendParams.degradationPreference) === null ||
                      _g === void 0
                        ? void 0
                        : _g.length)
                    ) {
                      ...
                      logger.info(
                        "[createOffer] Video sender Degradation Preference set: ".concat(
                          sendParams.degradationPreference,
                        ),
                      );
                      needSetParams = true;
                    ...
                    if (this.configuration.simulcast) {
                      if (
                        ((_h = sendParams.encodings) === null || _h === void 0
                          ? void 0
                          : _h.length) !== tcInit.sendEncodings.length
                      ) {
                    ...
                    logger.debug(
                      "[createOffer] Setting new RTCRtpSendParameters to video sender",
                    );
                    _m.label = 2;
                  case 2:
                    _m.trys.push([2, 4, , 5]);
                  ...
                  case 10:
                    error_2 = _m.sent();
                    message =
                      "[WebRtcPeer.createOffer] Browser failed creating an SDP Offer";
          ...
          WebRtcPeer.prototype.deprecatedPeerConnectionTrackApi = function () {
            for (
              var _i = 0, _a = this.configuration.mediaStream.getTracks();
              _i < _a.length;
              _i++
            ) {
              var track = _a[_i];
          ...
          WebRtcPeer.prototype.processRemoteOffer = function (sdpOffer) {
            var _this = this;
            return new Promise(function (resolve, reject) {
              var offer = { type: "offer", sdp: sdpOffer };
              logger.debug(
                "SDP offer received, setting remote description",
                offer,
              );
              if (_this.pc.signalingState === "closed") {
                return reject(
                  "RTCPeerConnection is closed when trying to set remote description",
                );
              }
              _this
          ...
          WebRtcPeer.prototype.processLocalAnswer = function (answer) {
            ...
            return new Promise(function (resolve, reject) {
              ...
              if (_this.pc.signalingState === "closed") {
                return reject(
                  "RTCPeerConnection is closed when trying to set local description",
                );
              }
              _this.pc
          ...
          WebRtcPeer.prototype.processRemoteAnswer = function (sdpAnswer) {
            var _this = this;
            return new Promise(function (resolve, reject) {
              var answer = { type: "answer", sdp: sdpAnswer };
          ...
          WebRtcPeer.prototype.addIceConnectionStateChangeListener = function (
            otherId,
          ) {
            var _this = this;
            this.pc.addEventListener("iceconnectionstatechange", function () {
              ...
              switch (iceConnectionState) {
                case "disconnected":
                  ...
                  logger.warn(msg1);
                  _this.configuration.onIceConnectionStateException(
                    ExceptionEvent_1.ExceptionEventName
                      .ICE_CONNECTION_DISCONNECTED,
                    msg1,
                  );
    ...
    85: [
        ...
        var WebRtcStats = (function () {
          ...
          WebRtcStats.prototype.initWebRtcStats = function () {
            ...
            if (!!webrtcObj) {
              ...
              logger.warn(
                "localStorage item: " + JSON.stringify(webrtcStatsConfig),
              );
                  ...
                  switch (_b.label) {
                    ...
                    case 1:
                      ...
                      if (transportStat != null) {
                        selectedCandidatePairId =
                          transportStat.selectedCandidatePairId;
                        selectedCandidatePair = candidatePairs.get(
                          selectedCandidatePairId,
                        );
                      } else {
                      ...
                      finalLocalCandidate =
                        localCandidates.get(localCandidateId);
                      if (!!finalLocalCandidate) {
                        candList = this.stream.getLocalIceCandidateList();
                        cand = candList.filter(function (c) {
                          return (
                            !!c.candidate &&
                            (c.candidate.indexOf(finalLocalCandidate.ip) >= 0 ||
                              c.candidate.indexOf(
                                finalLocalCandidate.address,
                              ) >= 0) &&
                      ...
                      finalRemoteCandidate =
                        remoteCandidates.get(remoteCandidateId);
                      if (!!finalRemoteCandidate) {
                        candList = this.stream.getRemoteIceCandidateList();
                        cand = candList.filter(function (c) {
                          return (
                            !!c.candidate &&
                            (c.candidate.indexOf(finalRemoteCandidate.ip) >=
                              0 ||
                              c.candidate.indexOf(
                                finalRemoteCandidate.address,
                              ) >= 0) &&
              ...
              return __generator(this, function (_a) {
                switch (_a.label) {
                  ...
                  case 2:
                    error_1 = _a.sent();
                    logger.error(
                      "sendStats error: ".concat(JSON.stringify(error_1)),
                    );
                    return [3, 3];
                  case 3:
                    return [2];
                          ...
                          case 1:
                            ...
                            statsReport.forEach(function (stat) {
                              ...
                              var addStat = function (direction, key) {
                                if (
                                  stat[key] != null &&
                                  response_1[direction] != null
                                ) {
                                  if (
                                    !mediaType &&
                                    videoTrackStats_1.indexOf(key) > -1
                                  ) {
                                    mediaType = "video";
                                  }
                                  if (
                                    ...
                                    mediaType != null &&
                                    key != null &&
                                    response_1[direction][mediaType] != null
                                  ) {
                                    response_1[direction][mediaType][key] =
                                      Number(stat[key]);
                                  } else if (
                                    direction != null &&
                                    key != null &&
                                    candidatePairStats_1.includes(key)
                                  ) {
                                    response_1[direction][key] = Number(
                                      stat[key],
                                    );
                                  }
                                }
                            ...
                            if (
                              !(response_1 === null || response_1 === void 0
                                ? void 0
                                : response_1.candidatepair) ||
                              Object.keys(response_1.candidatepair).length === 0
                            ) {
          ...
          WebRtcStats.prototype.getWebRtcStatsResponseOutline = function () {
            if (this.stream.isLocal()) {
              return { outbound: { audio: {}, video: {} }, candidatepair: {} };
            } else {
              return { inbound: { audio: {}, video: {} } };
            }
          };
          return WebRtcStats;
        })();
      ...
      { "../Logger/OpenViduLogger": 79, "../Utils/Platform": 83 },
    ],
  },
  {},
  [40],
